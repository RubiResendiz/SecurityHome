...
public class fragmentInvitado extends Fragment{
    ...
    List<ListElementInvitados> elements;
                            ...
                            if (dataSnapshot.exists()) {
                                for (DataSnapshot citi : dataSnapshot.getChildren()) {
                                    ...
                                    if(id_invitado.equals(invitado)){
                                        ...
                                        elements.add(new ListElementInvitados(nombre, telefono, id_invitado));
                                        Log.i("número de productos :D", invitados.size()+"");
                                        ListAdapterInvitados listAdapter = new ListAdapterInvitados(elements, getContext());
